...
@endpush
<div x-data="{ show: true, case_number: false ,court:false }">
    <form wire:submit.prevent="submitForm" class="careers-form">
            ...
            <div class="checkbox-section ">
                <div class="radio-button-block checkbox-block">
                    <div class=" radio-check">
                        <input type="radio" id="Cases" wire:model="ristrict" value="cases" @click="show = true">
                        <label class="radio-btn-label" for="Cases"> {{ trans('site.cases') }}</label>
                    </div>
                </div>
                <div class="radio-button-block checkbox-block">
                    <div class=" radio-check">
                        <input type="radio" id="arbitration" wire:model="ristrict" value="arbitration" @click="show = false">
        ...
        <div>
            ...
            <input type="number" wire:model="id_number" class="form-input" required>
            @error('id_number')
            <small class="text-danger">
                {{ $message }}
            </small>
        ...
        <div>
            ...
            <textarea wire:model="case_summary" class="form-input form-textarea textarea-text case-summary-textarea">
            {{ trans('site.enter_case_details') }}
            </textarea>
            @error('case_summary')
            <small class="text-danger">
                {{ $message }}
            ...
            <div class="upload__btn-box">
                <label class="form-input upload__btn" id="file" for="customFile">
                    <b class="upload-file">
                        ...
                        {{ trans('site.add_file') }}</b>
                    <input type="file" wire:model="file" wire:loading class="upload__inputfile" id="customFile" multiple>
                </label>
            </div>
