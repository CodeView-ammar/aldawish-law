                ...
                <div class="careers-form-section w-848">
                    <div class="notifications-title-bar">
                     ...
                     <div class="d-flex justify-content-center gap-2">
                         @if(!$order?->cancellation || $order->status->value != 'completed' )
                             <a class="delete-notifications back"  onclick="Livewire.dispatch('openModal', { component: 'cancel-order', arguments: { cancel_resouns: {{ $cancel_resouns }}, order : {{ $order }} }})">
