...
use Tasawk\Filament\Pages\BlogPage;  // إضافة صفحة المدونة
...
class AdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->navigationGroups([
                NavigationGroup::make()->label(fn(): string => __('menu.crm')),
                NavigationGroup::make()->label(fn(): string => __('menu.bloger')),
                NavigationGroup::make()->label(fn(): string => __('menu.catalog')),
                NavigationGroup::make()->label(fn(): string => __('menu.employees')),
                NavigationGroup::make()->label(fn(): string => __('menu.content')),
                NavigationGroup::make()->label(fn(): string => __('menu.notifications')),
            ...
            ->navigationItems([
                // إضافة المدونة كعنوان في الشريط الجانبي وليس كروابط
            ])
            ->resources([
                // يمكنك إضافة الموارد الخاصة بك هنا
            ])
            ->middleware([
