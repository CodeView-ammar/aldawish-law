...
class Register extends Component {
    ...
    public function register() {
        ...
        $customer = User::create(['name' => $this->name, 'email' => $this->email, 'phone' => "+" . $this->country_key . $this->phone, 'password' => $this->password, 'birthday' => $this->birthday, 'gender' => $this->gender, 'id_number' => $this->id_number, 'nationality' => $this->nationality, 'passport_number' => $this->passport_number, 'address' => $this->address]);
