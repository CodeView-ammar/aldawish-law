...
class FontawesomeIcons {
    public string $mode = 'social';

    static public function make() {
        return new static();
    }

    public function setMode($model): static {
        $this->mode = $model;
        return $this;
    }
    ...
    public function all(): array {
        return [
            ...
            'fa-user-headset' => 'user-headset',
            'fa-ballot-check' => 'ballot-check',
            'fa-truck' => 'truck',
            'fa-credit-card' => 'credit-card',
            'fa-arrow-progress' => 'arrow-progress',
            'fa-rectangle-history' => 'rectangle-history',
            'fab fa-500px' => '500px',
            ...
            'fab fa-x-twitter-square' => 'x-twitter-square',
            'fab fa-typo3' => 'typo3',
            'fab fa-uber' => 'uber',
            'fab fa-uikit' => 'uikit',
    ...
    public function social(): array {
        return [
            ...
            'fab fa-map-marker' => 'fa-map-marker',
        ]; 
    }
    ...
    public function toSelect(): array {
        return collect($this->get())->mapWithKeys(fn($item, $key) => [$item =>
            <<<HTML
<i class="$key"> $item
HTML
